...
with open(os.path.join(args.work_dir, 'model_FT_mixed_40_50_local.pt'), 'rb') as f:
...
logging(f'Evaluating  model_FT_mixed_40_50_local with bsz {args.batch_size} tgt_len {args.tgt_len} '
